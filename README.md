...
4. supaya dapat mencetak garis bintang pada baris yang baru, jika dihilangkan, maka bintang yang akan dicetak akan sejajar atau horizontal
5. done

---
# Percobaan 3

Pada percobaan ke-3 akan dilakukan percobaan segitiga *, dengan sama siku dengan tinggi sebesar N. Misalkan N dimasukan 5, maka hasilnya adalah:
...
1. tidak, hasilnya berbeda
2. ada bagian yang harus ditambahkan yaitu, System out println pada:
...
```java
    public static void main(String[] args) {
        ...
        while(i <= N) {
            ...
            System.out.println(); //ini yang perlu ditambahkan disini
            i++;
        }
        sc.close();
    }
